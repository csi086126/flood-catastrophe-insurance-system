...
//     endTime: "2022-12-31",
//     years: 100,
//     annualTotalLoss: 500.25,
//     standDerivation: 10.25,
//     status: "Completed",
//   },
//   {
//     id: "PROJ-002",
      ...
      <div className=" mx-auto px-4 py-2 flex justify-between items-center ml-2">
        ...
        <nav className="flex-grow flex justify-end">
          <ul className="flex space-x-4">
            ...
            <li><Button variant="ghost">Risk Analysis</Button></li>
            <li className="ml-auto"><Button variant="ghost">Risk Statistics</Button></li>
          </ul>
        </nav>
      </div>
    </header>
      ...
      if (project.status === "Completed") {
        ...
        .then(geojson => {
          if (geojson && geojson.features && geojson.features.length > 0) {
            ...
            // // 定义 EPSG:2326 坐标系
            // proj4.defs("EPSG:2326", "+proj=tmerc +lat_0=22.31213333333333 +lon_0=114.1785555555556 +k=1 +x_0=836694.05 +y_0=819069.8 +ellps=GRS80 +units=m +no_defs");
            // const fromProjection = 'EPSG:2326';
            // const toProjection = 'EPSG:4326';

            // const transform = proj4(fromProjection, toProjection);
            // geojson.features.forEach(feature => {
            //   feature.geometry.coordinates = transformCoordinates(feature.geometry.coordinates, transform);
            // });
